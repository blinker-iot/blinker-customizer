...
export default {
  ...
  methods: {
    ...
    getHistory:function(key) {
      send2Device({"get":"history",key:key,quickCode:this.quickCode});
    }
  }
};
</script>
